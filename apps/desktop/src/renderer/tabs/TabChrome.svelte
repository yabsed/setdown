...
<nav class="tab-strip" aria-label="Open documents">
  ...
  <div class="tab-actions">
    ...
    <button class="editor-action insert-table-button" type="button" title="Insert table" aria-label="Insert table" onclick={actions.openTable}>
    ...
    <button class="editor-action insert-link-button" type="button" title="Insert URL (Ctrl/Cmd+K)" aria-label="Insert URL" onclick={actions.openLink}>
    ...
    <button class="mode-toggle" type="button" hidden={view.surface === 'empty'}
      title={`${view.surface === 'viewer' ? 'Switch to Editor' : 'Switch to Viewer'} (Ctrl/Cmd+E)`}
      aria-label={view.surface === 'viewer' ? 'Switch to Editor' : 'Switch to Viewer'}
