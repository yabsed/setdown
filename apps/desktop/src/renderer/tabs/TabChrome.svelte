...
<nav class="tab-strip" aria-label="Open documents">
  <div class="tab-list" role="tablist">
    {#each view.tabs as tab (tab.id)}
      <button
        ...
        type="button"
        role="tab"
        aria-selected={tab.active && !project.gitDiffActive}
        title={tab.path}
        draggable="true"
        data-tab-id={tab.id}
  ...
  <div class="tab-actions">
    ...
    <button class="editor-action insert-table-button" type="button" hidden={project.gitDiffActive}
    ...
    <button class="editor-action insert-link-button" type="button" hidden={project.gitDiffActive}
    ...
    <span class="tab-action-divider" aria-hidden="true" hidden={project.gitDiffActive}></span>
    <button class="mode-toggle" type="button"
      hidden={(!project.gitDiffActive && view.surface === 'empty') || project.gitDiffLoading}
      ...
      {#if project.gitDiffActive && project.gitDiff
        ? project.gitDiffMode === 'rendered' : view.surface === 'viewer'}
